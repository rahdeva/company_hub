...
class TambahTugasPegawaiPage extends StatelessWidget {
  const TambahTugasPegawaiPage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TambahTugasPegawaiController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBarWidget.secondaryAppbar(
            context: context,
            titleString: 'Tambah Tugas Pegawai',
          ),
          body: FormBuilder(
