...
class TugasPegawaiPage extends StatefulWidget {
  const TugasPegawaiPage({super.key});

  @override
  State<TugasPegawaiPage> createState() => _TugasPegawaiPageState();
}

class _TugasPegawaiPageState extends State<TugasPegawaiPage> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<TugasPegawaiController>(
      builder: (controller) {
        return Scaffold(
          ...
          floatingActionButton: TambahFloatingActionButton(
            onTap: (){
              Get.toNamed(PageName.TAMBAH_TUGAS_PEGAWAI);
            }
          ),
        );
      }
